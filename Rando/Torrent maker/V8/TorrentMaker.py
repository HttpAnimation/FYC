...
# Define function to clear text in prompts
def clear_prompts():
    entry_name.delete(0, tk.END)
    entry_desc.delete(0, tk.END)
    entry_link.delete(0, tk.END)
    entry_dir.delete(0, tk.END)
    entry_magnet.delete(0, tk.END)
...
# Define "Generate Torrent" button
button_generate = tk.Button(window, text="Generate Torrent", command=lambda: [generate_torrent(), clear_prompts()])
